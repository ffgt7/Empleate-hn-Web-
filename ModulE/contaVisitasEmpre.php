...
?>
    ...
    $sql="select nomb_user, img_perfil,num_visitas, fecha from contadorempre join usuarios_empleo on contadorempre.cod_visitante = usuarios_empleo.cod_empleo 
    ...
    $sql2="select nomb_user, img_perfil, num_visitas, fecha from contadorempre join usuarios_empleo on contadorempre.cod_visitante = usuarios_empleo.cod_empleo 
            				    ...
            				    <div class="services-wrapper" style="padding: 10px; margin-bottom: 10px;">
                                    <div class="media">
                                        <div class="media-left">
                                            <img src="../Imagenes_Users/<?php echo $elementos['img_perfil'] ?>" class="media-object imagen" style="width:100px; height: 50px;">
                                        </div>
                                        <div class="media-body">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <h4 class="media-heading media-left">Nombre de usuario: <?php echo $elementos['nomb_user'] ?></h4>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
