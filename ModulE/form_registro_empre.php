			...
			<div class="row">
		  	...
		  	<div class="col-sm-4">
					<div class="slider-box-appointment" >
						<div class="header">
							<h3 class="heading font-2 text-center">Recuperar Contraseña Empresa</h3>
						</div>
						<hr class="hr-2">
						<div class="body">

						  <form id="frmRestablecer" action="validaremail_empre.php" method="post">
