<?php
  require "../lib/conexion.php";
    ...
    $cod=$_GET["cod"];
  $sql5="select cod_curriHabi, habilidad, nombAplica, nivel from curriHabilidades join habilidades on cod_habilidad=fk_habilidad join aplicaciones on cod_aplicacion=fk_aplicacion
