...
/*	 */
  ...
  require "../lib/conexion.php";
    ...
    $cod=$_GET["cod"];
    $sql5="select apellidos, cod_empleo,email_user,direccion,Fech_regisUser,Fech_Naci,img_perfil,nombres,identidadC,sexo,tel_fijo,tel_movil,depart,nacionalidad,muni
