...
<?php
	...
	$sql="SELECT cod_usuario,descripcion,email,imagen,nomb_empre,fk_rubro,nomb_usuario,num_tel,pass,Pregunt_Seguri,web_site,respuesta,rubro,Preg_Segur FROM usuarios_empre JOIN rubros on cod_rubro=fk_rubro JOIN preg_segur on cod_preg=Pregunt_Seguri WHERE cod_usuario=$cod";
