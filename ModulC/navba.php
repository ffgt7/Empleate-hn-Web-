...
?>
	...
	<script src="../ModulK/ckeditor/ckeditor.js"></script>
	<script src="../ModulK/ckfinder/ckfinder.js"></script>
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					if(isset($_SESSION['cod_usuario'])){
						?><li style="font-family: segoe script; font-size: 12px;"><a class="list-group-item-info" href="perfil_usuario.php">PERFIL</a></li><?php
					}
					if(isset($_SESSION['cod_usuarioE'])){
						?><li style="font-family: segoe script; font-size: 12px;"><a class="list-group-item-info" href="perfil_empresa.php">PERFIL</a></li><?php
					}
						if(isset($_SESSION['codAdmin'])){
						?><li style="font-family: segoe script; font-size: 12px;"><a class="list-group-item-info" href="perfilAdministrador.php">PERFIL</a></li><?php
					}
					?>
				...
				?>
					...
					<li style="font-family: segoe script; font-size: 12px;"><a class="list-group-item-info" href="loginUsuario.php">USUSARIO</a></li>
