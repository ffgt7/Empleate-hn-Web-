...
<head>
<meta charset="utf-8">
<title>Articulos/Demanda Laboral</title>
...
<?php
	...
	$sql2="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='8' order by fecha DESC";
	...
	$consulta="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='8' order by fecha DESC LIMIT $empezar_desde,$tamano_paginas";
...
<div class="container">
	<div class="row">
		<section id="services" >
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row text-center header animate-in" data-anim-type="fade-in-up">
					<h3 style="color: white;">Demanda Laboral</h3>
				</div>
			</div>
			<div class="col-lg-12">
			<div class="col-lg-3">
