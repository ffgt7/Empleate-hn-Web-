...
$sql3="select codVideo,FKcategoria,link,descripcion,titulo,categoria,fecha from videos join catevideos on codCateVideo=FKcategoria where FKcategoria='1'";
...
$consulta="select codVideo,FKcategoria,link,descripcion,titulo,categoria,fecha from videos join catevideos on codCateVideo=FKcategoria where FKcategoria='1' LIMIT $empezar_desde,$tamano_paginas";
		...
		<section id="services" >
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row text-center header animate-in" data-anim-type="fade-in-up">
					<h3 style="color: white;">Motivacopnales</h3>
				</div>
			</div>
			<div class="col-lg-12">
				<div class="col-lg-3">
					<div class="services-wrapper">
						<aside class="right-sidebar">
							...
							<li class="list-group-item btn-info"><a class="text btn" href="verVideos.php">Todas Catégorias <span class="badge w3-blue-gray"><?php echo $nn ?></span></a></li>
								...
								<li class="list-group-item btn-info"><a class="text" href="tips.php"><span class="badge w3-blue"><?php echo $nnnn ?></span> Tips</a></li>
