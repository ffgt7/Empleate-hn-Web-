...
<head>
<meta charset="utf-8">
<title>Articulos/Curriculum</title>
...
<?php
	...
	$sql2="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='2' order by fecha DESC";
	...
	$consulta="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='2' order by fecha DESC LIMIT $empezar_desde,$tamano_paginas";
