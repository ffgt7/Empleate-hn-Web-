...
if (strlen($busqueda_dinosaurio) > 0) 
{
    ...
    if ($row_cnt==0) { ?>
<span class ='buscador_sin_resultados' style="color:black;"> sin resultados </span><?php
    } 
    else 
    {
        foreach($array_propuestas as $elemento) 
        { ?>
<span class ='buscador_sin_resultados' style="color:black;"><?php echo $elemento['nomb_empre']; ?></span>
        </br>
        <?php 
