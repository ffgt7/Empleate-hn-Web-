...
<head>
<meta charset="utf-8">
<title>Articulos/Entrevistas</title>
...
<?php
	...
	$sql2="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='5' order by fecha DESC";
	...
	$consulta="select codBlog,blog,fecha,categoria,cate,FKcreador,userAdmin from blog join cateblog on codCate=categoria join admin on codAdmin=FKcreador where categoria='5' order by fecha DESC LIMIT $empezar_desde,$tamano_paginas";
		...
		<section id="services" >
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row text-center header animate-in" data-anim-type="fade-in-up">
					<h3 style="color: white;">Entrevistas</h3>
				</div>
			</div>
			<div class="col-lg-12">
			<div class="col-lg-3">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				?><ul id="pagination-digg"><?php
					...
					<?php } 
							...
							{ ?>
								<li class="nextt"><a class="text" href="?pagina=<?php echo $nextpage ?>" style="font-size:15px">&raquo;</a></li>
								<li class="nextt"><a class="text" href="?pagina=<?php echo $total_paginas ?>" style="font-size:15px">&raquo;&raquo;</a></li><?php
							}
							else
							{ ?>		
